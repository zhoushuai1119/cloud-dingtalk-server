...
import com.cloud.dingtalk.dinger.bytetalk.entity.ByteText;
import com.cloud.dingtalk.dinger.core.entity.DingerRequest;
import com.cloud.dingtalk.dinger.core.entity.MsgType;
import com.cloud.dingtalk.dinger.dingtalk.entity.*;
import com.cloud.dingtalk.dinger.exception.DingerException;
import com.cloud.dingtalk.dinger.utils.DingerUtils;
import com.cloud.dingtalk.dinger.wetalk.entity.WeMarkdown;
import com.cloud.dingtalk.dinger.wetalk.entity.WeNews;
import com.cloud.dingtalk.dinger.wetalk.entity.WeText;
...
import static com.cloud.dingtalk.dinger.constant.DingerConstant.DINGER_COMMA;
import static com.cloud.dingtalk.dinger.core.DingerDefinitionHandler.WETALK_AT_ALL;
    ...
    TEXT(true) {
        ...
        public MsgType msgType(DingerType dingerType, DingerRequest request) {
            ...
            if (dingerType == DingerType.DINGTALK) {
                ...
                throw new DingerException(ExceptionEnum.DINGER_UNSUPPORT_MESSAGE_TYPE_EXCEPTION, dingerType, this.name());
            }
        }
    },
