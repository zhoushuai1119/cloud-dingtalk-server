...
import com.cloud.dingtalk.dinger.core.annatations.Dinger;
import com.cloud.dingtalk.dinger.core.annatations.DingerPhone;
...
import com.cloud.dingtalk.dinger.core.entity.enums.PhoneParamType;
import com.cloud.dingtalk.dinger.constant.DingerConstant;
import com.cloud.dingtalk.dinger.multi.MultiDingerConfigContainer;
import com.cloud.dingtalk.dinger.multi.MultiDingerProperty;
...
import static com.cloud.dingtalk.dinger.constant.DingerConstant.DINGER_PREFIX;
import static com.cloud.dingtalk.dinger.constant.DingerConstant.SPOT_SEPERATOR;
...
public class DingerMessageHandler
    ...
    public Map<String, Object> paramsHandler(Method method, DingerDefinition dingerDefinition, Object[] values) {
        ...
        for (int i = 0; i < parameters.length; i++) {
            ...
            com.cloud.dingtalk.dinger.core.annatations.Parameter[] panno =
                    parameter.getDeclaredAnnotationsByType(com.cloud.dingtalk.dinger.core.annatations.Parameter.class);
