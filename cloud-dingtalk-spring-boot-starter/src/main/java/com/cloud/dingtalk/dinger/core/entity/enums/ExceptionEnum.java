...
import com.cloud.dingtalk.dinger.core.entity.ExceptionPairs;
import com.cloud.dingtalk.dinger.exception.*;
...
public enum ExceptionEnum implements ExceptionPairs {
    /** 发送异常, 1XXX, {@link SendMsgException} */
    ...
    /** 异步调用相关异常, {@link AsyncCallException} */
    ...
    /** 配置文件相关异常, 5XXX, {@link InvalidPropertiesFormatException} */
