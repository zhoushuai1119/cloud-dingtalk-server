 ...
 */
package com.cloud.dingtalk.dinger.multi;
...
import com.cloud.dingtalk.dinger.core.entity.enums.ExceptionEnum;
import com.cloud.dingtalk.dinger.exception.DingerException;
import com.cloud.dingtalk.dinger.exception.MultiDingerRegisterException;
import com.cloud.dingtalk.dinger.listeners.DingerListenersProperty;
import com.cloud.dingtalk.dinger.multi.algorithm.AlgorithmHandler;
import com.cloud.dingtalk.dinger.multi.annotations.EnableMultiDinger;
import com.cloud.dingtalk.dinger.multi.annotations.MultiDinger;
import com.cloud.dingtalk.dinger.multi.annotations.MultiHandler;
...
import static com.cloud.dingtalk.dinger.multi.MultiDingerConfigContainer.GLOABL_KEY;
        ...
        implements ImportBeanDefinitionRegistrar, Ordered
{
    ...
    private void registerHandler(BeanDefinitionRegistry registry, DingerType dinger, String key, DingerConfigHandler dingerConfigHandler) {
        ...
        if (!dinger.isEnabled()) {
            throw new DingerException(ExceptionEnum.MULTIDINGER_ANNOTATTION_EXCEPTION, key, dinger);
        }
        ...
        if (injectionCnt == 0) {
            ...
            // 将当前算法注册到Spring容器中
            String beanName = key + DingerConstant.SPOT_SEPERATOR + algorithm.getSimpleName();
